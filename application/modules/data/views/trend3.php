                ...
                <?php
                        ...
                        $dim1=Modules::run('data/dimalldisplay',$this->uri->segment(3));
                                    ...
                                    foreach ($dim1 as $dim){ ?>
                                        ...
                                        <li class="<?php if ($this->uri->segment(2)=='dimension3') { echo ''; } ?>"> <a href="<?php echo base_url().'data/dimension3/'.$dim->kpi_id.'/'.$dimsub;?>" class="dropdown-item active"><?php echo $dim->dimension3_key; ?></a> </li> 
                                    <?php    }  
                        ?>
</ul>
</div>
