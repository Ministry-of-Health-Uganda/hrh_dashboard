...
$dimsub=Modules::run("data/getdimSubject",$this->uri->segment(3)); 
 ...
 $dim1=Modules::run('data/dimalldisplay',$this->uri->segment(3));
        ...
        foreach ($dim1 as $dim){ ?>
        <li class="<?php if ($this->uri->segment(2)=='dimension1') { echo ''; } ?>"> <a href="<?php echo base_url().'data/dimension1/'.$dim->kpi_id.'/'.$dimsub; ?>" class="dropdown-item active"><?php echo $dim->dimension1_key; ?></a> </li>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="tab-content p-0">
                  <!-- Morris chart - Sales -->
                  <div >
                       <div id="line<?php echo $chartkpi; ?>" style="width:100%;"> 
                     </div>                       
                   </div>
