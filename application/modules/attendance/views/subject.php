            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                        <!-- Add Subject -->
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#staticBackdrop" style="margin-bottom:3px; width:20%;"><i class="fa fa-plus">
                            </i>Add Subject
                            </button>
                            ...
                            <div class="card-content">
                                <table id="subject" class="table table-responsive table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <?php 
                                            $i=1;
                                        $elements=Modules::run('indicator/subjectData');
