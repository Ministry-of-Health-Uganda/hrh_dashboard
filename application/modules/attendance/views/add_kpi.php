  ...
  <div class="modal-dialog modal-lg" >
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="<?php echo base_url(); ?>indicator/addkpi" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                        ...
                        <div class="form-group row">
                          ...
                          <label for="subject" class="col-sm-3 col-form-label">
                           ...
                           <select name="subject_area" class="form-control codeigniterselect">
                             <?php    $elements=Modules::run('indicator/subjectData');
