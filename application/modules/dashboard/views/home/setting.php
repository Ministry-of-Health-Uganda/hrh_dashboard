            ...
            <div class="panel">
                ...
                <?php echo form_open_multipart('dashboard/setting/create','class="form-inner"') ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-9">
                            <textarea name="gauge_config" class="form-control"  placeholder="" maxlength="140" rows="15"><?php echo $setting->gauge_config ?></textarea>
                        </div>
                    </div>   
                    ...
                    <div class="form-group row">
                        ...
                        <?php $cols=array("Current FY"=>"0","Last FY"=>"1"); 
                        
                        foreach($cols as $key => $value){
                        ?>
                           <option value="<?php echo $value ?>" <?php if ($setting->financial_year==$value){ echo "selected"; } ?>><?php echo $key; ?></option>
                        <?php } ?>
