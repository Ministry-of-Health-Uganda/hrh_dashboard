...
Class Home extends 	MX_Controller {
	...
	function index($dashboard=FALSE){
	    $data['dashkpis']=$this->home_model->dashData();
		$data['module']      = "dashboard";
		$data['facilities'] = $this->home_model->facilityCount();
		...
		$data['uptitle']        = "HRH Dashboard";
		}
		else if ($dashboard=='ihris_dashboard'){
			$data['page']        = "home/".$dashboard;
			$data['title']        = "Dashboard";
			$data['uptitle']        = "iHRIS Performance Dashboard";
		}
