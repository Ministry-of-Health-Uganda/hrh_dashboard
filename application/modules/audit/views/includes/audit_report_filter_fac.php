<form class="form-horizontal row searchForm" method="post" action="<?php echo base_url()?>audit/printfacAudit?districts=<?php echo $_SESSION['district_id']?>&display=ihris">
